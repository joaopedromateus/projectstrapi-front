  ...
  return(
    <div className="shadow-lg shadow-[gray]/[0.3] border-b-[0.5px] border-[gray]"> 
      <div className="container mx-auto xl:max-w-[1180px] text-white flex items-center justify-between py-[15px]">
        <Link href='/'>
          <div className="h-[70px] flex items-center cursos-pointer">
    <Lottie animationData={animationData} height={70} width={70} className="lottie"/>
  <p className="font-bold uppercase text-[20px] hover:text-purple-900">Blogs</p>
          </div>
        ...
        <div>
          ...
          <input className="w-full border-none outline-none bg-transparent pl-[10px] placeholder:text-[15px]" type="text" placeholder="Search" />
          <BiSearch fontSixze={20} className="cursor-pointer"/>
            </div>
          </div>
        </div>
      </div>
